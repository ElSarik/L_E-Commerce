...
<div class="MainDisplay" align = "center"> 
	<div class="RegisterForm">
		...
		<img src="Images/user_register.png">
		
		<form action="register.php" method = "POST">	<!-- CHANGE HERE -->
			...
			<br>
			<div class="inputgroup">
				<input type="submit" id="btn" value="Register" name="register_btn" style="height:40px;color:#ffcc00;border:0;background-color:#4a4a4a;font-family:tahoma;font-size:20px;">
			</div>
