				...
				if($row['category'] == "Smartphone")
				{
					if($row['quantity'] > 5)
					{
						...
						'<div class="Product" id='.$row['id'].'> 
							...
							<div class="ProductName"> <a class="LinkFix" href="product.php?category=smartphones&sub_category='.$row['category'].'&id='.$row['id'].'">'.$row['title'].'</a></div>
							...
							<div class="ProductCart">
								...
								<div>
									<a href="Smartphones_cat.php?category=smartphones&sub_category='.$row['category'].'&id='.$row['id'].'&AddToCart=true"><img src="Images/AddToCart.jpeg"></a>
								</div>
								<div> <a href="modify.php?category=smartphones&sub_category='.$row['category'].'&id='.$row['id'].'">Modify Product </a> </div>				
							</div>
