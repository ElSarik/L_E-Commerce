	...
	<div class="FiltersLeft">
		<div>
			<ul class="FilterOrder">
				...
				<?php
					$result = mysqli_query($db,"SELECT DISTINCT(manufacturer) FROM smartphones WHERE category = 'case' AND manufacturer !=''");
...
$(document).ready(function(){
    ...
    function ProductDisplay()
    {
        ...
        $.ajax({
            url:"filters.php",
            method:"POST",
            data:{cases:cases, manufacturer:manufacturer, under5:under5, between510:between510, over10:over10},
