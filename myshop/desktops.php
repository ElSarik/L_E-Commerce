	...
	<div class="FiltersLeft">
		<div>
			<ul class="FilterOrder">
				...
				<?php
					$result = mysqli_query($db,"SELECT DISTINCT(manufacturer) FROM computers WHERE category = 'Desktops' AND manufacturer !=''");
		...
		<div>
			<ul class="FilterOrder">
				...
				<?php
					$result = mysqli_query($db,"SELECT DISTINCT(cpu) FROM computers WHERE category = 'Desktops' AND cpu !=''");
                    foreach($result as $row)
                    {
                    ?>
		...
		<div>
			<ul class="FilterOrder">
				...
				<?php
					$result = mysqli_query($db,"SELECT DISTINCT(ram) FROM computers WHERE category = 'Desktops' AND ram !=''");
                    foreach($result as $row)
                    {
                    ?>
		...
		<div>
			<ul class="FilterOrder">
				...
				<?php
					$result = mysqli_query($db,"SELECT DISTINCT(storage) FROM computers WHERE category = 'Desktops' AND storage !=''");
                    foreach($result as $row)
                    {
                    ?>
		...
		<div>
			<ul class="FilterOrder">
				...
				<?php
					$result = mysqli_query($db,"SELECT DISTINCT(gpu) FROM computers WHERE category = 'Desktops' AND gpu !=''");
                    foreach($result as $row)
                    {
                    ?>
	...
	<div class="FiltersRight">
		<div>
			<ul class="FilterOrder">
				...
				<?php
					$result = mysqli_query($db,"SELECT DISTINCT(screen) FROM computers WHERE category = 'Desktops' AND screen !=''");
                    foreach($result as $row)
                    {
                    ?>
		...
		<div>
			<ul class="FilterOrder">
				...
				<?php
					$result = mysqli_query($db,"SELECT DISTINCT(os) FROM computers WHERE category = 'Desktops' AND os !=''");
                    foreach($result as $row)
                    {
                    ?>
...
$(document).ready(function(){
    ...
    function ProductDisplay()
    {
        ...
        $.ajax({
            url:"filters.php",
            method:"POST",
            data:{desktops:desktops, manufacturer:manufacturer, cpu:cpu, ram:ram, storage:storage, gpu:gpu, screen:screen, os:os, under500:under500, between5001000:between5001000, over1000:over1000},
