	...
	<div class="FiltersLeft">
		<div>
			<ul class="FilterOrder">
				...
				<?php
					$result = mysqli_query($db,"SELECT DISTINCT(manufacturer) FROM computers WHERE category = 'tablets' AND manufacturer !=''");
		...
		<div>
			<ul class="FilterOrder">
				...
				<?php
					$result = mysqli_query($db,"SELECT DISTINCT(cpu) FROM computers WHERE category = 'tablets' AND cpu !=''");
                    foreach($result as $row)
                    {
                    ?>
		...
		<div>
			<ul class="FilterOrder">
				...
				<?php
					$result = mysqli_query($db,"SELECT DISTINCT(ram) FROM computers WHERE category = 'tablets' AND ram !=''");
                    foreach($result as $row)
                    {
                    ?>
		...
		<div>
			<ul class="FilterOrder">
				...
				<?php
					$result = mysqli_query($db,"SELECT DISTINCT(storage) FROM computers WHERE category = 'tablets' AND storage !=''");
                    foreach($result as $row)
                    {
                    ?>
		...
		<div>
			<ul class="FilterOrder">
				<li class="FilterText">Camera: </li>
				<?php
					$result = mysqli_query($db,"SELECT DISTINCT(gpu) FROM computers WHERE category = 'tablets' AND gpu !=''");
                    foreach($result as $row)
                    {
                    ?>
	...
	<div class="FiltersRight">
		<div>
			<ul class="FilterOrder">
				...
				<?php
					$result = mysqli_query($db,"SELECT DISTINCT(screen) FROM computers WHERE category = 'tablets' AND screen !=''");
                    foreach($result as $row)
                    {
                    ?>
		...
		<div>
			<ul class="FilterOrder">
				...
				<?php
					$result = mysqli_query($db,"SELECT DISTINCT(os) FROM computers WHERE category = 'tablets' AND os !=''");
                    foreach($result as $row)
                    {
                    ?>
		...
		<div>
			<ul class="FilterOrder">
				...
				<label> <li class="Filter"> <input type="checkbox" onclick="change_color(this);" class="common_selector under500" value="under500"> Under 100€</li></label>
				<label> <li class="Filter"> <input type="checkbox" onclick="change_color(this);" class="common_selector between5001000" value="between5001000"> 100€ - 300€</li></label>
				<label> <li class="Filter"> <input type="checkbox" onclick="change_color(this);" class="common_selector over1000" value="over1000"> Over 300€</li></label>
			</ul>
		</div>
	</div>
</div>
...
$(document).ready(function(){
    ...
    function ProductDisplay()
    {
        ...
        $.ajax({
            url:"filters.php",
            method:"POST",
            data:{tablets:tablets, manufacturer:manufacturer, cpu:cpu, ram:ram, storage:storage, gpu:gpu, screen:screen, os:os, under500:under500, between5001000:between5001000, over1000:over1000},
